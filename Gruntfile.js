module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      scripts : {
        files: ['src/js/**/*.js'],
        tasks: ['newer:jshint:all', 'concat:js', 'uglify:dist']
      }
    },
    ...
    cssmin: {
      ...
      dist: {
        files: {'public/css/styles.min.css': 'src/dist/styles.css'}
      }
    },
    ...
    copy: {
      dist: {
        files: [
          { expand: true, cwd: 'src', src: [ 'favicon.ico', 'CNAME' ], dest: 'public/', filter: 'isFile' },
  ...
  /* MAKE SURE YOU WANT THIS TO GO LIVE BABY *************/
